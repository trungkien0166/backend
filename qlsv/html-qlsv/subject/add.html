...
<html lang="en">
	...
	<body>
		<div class="container" style="margin-top:20px;">
			<a href="../student/list.html" class=" btn btn-info">Students</a>
			<a href="../subject/list.html" class="active btn btn-info">Subject</a>
			...
			<h1>Thêm Môn Học</h1>
			<form action="list.html" method="POST" accept-charset="utf-8">
				<div class="container">
					<div class="row">
						<div class="col-md-5">
